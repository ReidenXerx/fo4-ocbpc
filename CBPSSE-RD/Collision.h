// fo4-ocbpc: modified by fo4-anatomy (ReidenXerx), 2026-09-23: a prop collider flag.
...
public:
	...
	bool IsItColliding(NiPoint3 &collisiondif, std::vector<Sphere> thingCollisionSpheres, std::vector<Sphere> collisionSpheres, bool maybe);
